...
// migrationsDir resolves the absolute path of the backend's migrations directory
// using the compiled-in location of this file. It works regardless of the test
// working directory.
func migrationsDir() string {
	_, thisFile, _, _ := runtime.Caller(0)
	// thisFile = .../services/admin/backend/internal/testdb/testdb.go
